...
describe('styles source', () => {
  ...
  it('contains workspace focus layout, paged task sidebar and task state styles', () => {
    ...
    expect(source).toContain('minmax(360px, 1.08fr) minmax(0, 1.52fr);')
    ...
    expect(source).toContain('.task-sidebar-summary')
    expect(source).toContain('.workspace-panel--result-stage')
