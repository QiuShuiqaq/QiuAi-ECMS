...
describe('component sources', () => {
  ...
  it('uses product-card workbench layout and simplified account-usage page', () => {
    ...
    expect(workbenchSource).toContain('当前标题：')
    expect(workbenchSource).toContain('标题来源：')
    expect(workbenchSource).toContain('当前描述：')
    expect(workbenchSource).toContain('描述来源：')
    expect(workbenchSource).toContain('图片采用：')
    expect(workbenchSource).toContain('视频采用：')
    ...
    expect(workbenchSource).toContain('Automation Status: PENDING_DEVELOPMENT')
